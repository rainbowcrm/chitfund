...
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Code',false,true,true,'SHOW','READONLY','SHOW','Code','Code','Code','Text',null,20)
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Name',false,false,true,'SHOW','SHOW','SHOW','Brand','Brand','Name','Text',null,50)
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Description', false,false,false,'SHOW','SHOW','SHOW','Description','Description','Description','Text',null,100)
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Email',false,false,true,'SHOW','SHOW','SHOW','Email','Email','Email','Email',null,30)
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Phone',false,false,true,'SHOW','SHOW','SHOW','Phone','Phone','Phone','Text',null,30)
INSERT INTO entity_fields (ENTITY_NAME,FIELD_NAME,IS_PK, IS_BK, IS_MANDATORY, LIST_PAGE_BV, EDIT_PAGE_BV,  ADD_PAGE_BV, UI_LABEL_KEY,UI_LABEL_VALUE,JSON_TAG,DISPLAY_CONTROL,VALUE_POPULATOR,SCREEN_WIDTH)
VALUES( 'Brand','Id',true,false,false,'HIDE','HIDE','HIDE','Id','Id','Id','Text',null,20)